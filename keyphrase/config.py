...
def setup_keyphrase_all():
    ...
    # trained_model
    config['trained_model']   = path.realpath(path.curdir) + '/Experiment/' + 'copynet-keyphrase-all.one2one.copy/experiments.copynet-keyphrase-all.one2one.copy.id=20161219-211936.epoch=1.batch=57000.pkl'
    ...
    config['training_archive']= config['path_experiment'] + '/save_training_status.id=20161219-211936.epoch=1.batch=57000.pkl'
